...
export default function InsertSelectorPage() {
  const [operation, setOperation] = useState<InsertOperation>("turning-ext");
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_420px]">
        ...
        <div className="space-y-4 lg:sticky lg:top-20 lg:self-start">
          ...
          <Card className="p-4 text-xs text-muted">
            این ابزار رایگان توسط تیم مهندسی <span className="font-semibold text-foreground">ارس زنجان (AZCO)</span> در اختیار
            جامعه ماشین‌کاری و قالب‌سازی قرار گرفته است. برای پرس‌های هیدروپنوماتیک، پنوماتیک و اجزای استاندارد قالب، به{" "}
